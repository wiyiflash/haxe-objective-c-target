...
{
HX_STACK_PUSH("FastCell::new","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",30);
{
	HX_STACK_LINE(30)
	this->elt = elt;
	HX_STACK_LINE(30)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxe.FastCell"), hx::TCanCast< FastCell_obj> ,sStaticFields,sMemberFields,
