...
{
HX_STACK_PUSH("FastList::new","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",60);
{
}
;
	return null();
...
::String FastList_obj::toString( ){
	HX_STACK_PUSH("FastList::toString","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",153);
	HX_STACK_THIS(this);
	HX_STACK_LINE(154)
...
Dynamic FastList_obj::iterator( ){
	HX_STACK_PUSH("FastList::iterator","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",126);
	HX_STACK_THIS(this);
	HX_STACK_LINE(126)
...
bool FastList_obj::remove( Dynamic v){
	HX_STACK_PUSH("FastList::remove","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",104);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(105)
...
bool FastList_obj::isEmpty( ){
	HX_STACK_PUSH("FastList::isEmpty","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",96);
	HX_STACK_THIS(this);
	HX_STACK_LINE(96)
...
Dynamic FastList_obj::pop( ){
	HX_STACK_PUSH("FastList::pop","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",83);
	HX_STACK_THIS(this);
	HX_STACK_LINE(84)
...
Dynamic FastList_obj::first( ){
	HX_STACK_PUSH("FastList::first","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",74);
	HX_STACK_THIS(this);
	HX_STACK_LINE(74)
...
{
		HX_STACK_PUSH("FastList::add","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",66);
		HX_STACK_THIS(this);
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxe.FastList"), hx::TCanCast< FastList_obj> ,sStaticFields,sMemberFields,
