...
{
HX_STACK_PUSH("Hash::new","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",25);
{
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_PUSH("*::closure","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",26);
			{
...
::String Hash_obj::toString( ){
	HX_STACK_PUSH("Hash::toString","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",72);
	HX_STACK_THIS(this);
	HX_STACK_LINE(73)
...
Dynamic Hash_obj::iterator( ){
	HX_STACK_PUSH("Hash::iterator","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",57);
	HX_STACK_THIS(this);
	HX_STACK_LINE(58)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &it,Array< ::Hash > &me){
			HX_STACK_PUSH("*::closure","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",62);
			{
				hx::Anon __result = hx::Anon_obj::Create();

				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_2_1,Dynamic,it)
				bool run(){
					HX_STACK_PUSH("*::_Function_2_1","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",63);
					{
						HX_STACK_LINE(63)
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_2","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",64);
					{
						HX_STACK_LINE(64)
...
Dynamic Hash_obj::keys( ){
	HX_STACK_PUSH("Hash::keys","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",48);
	HX_STACK_THIS(this);
	HX_STACK_LINE(49)
	Array< ::String > a = Array_obj< ::String >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(50)
...
bool Hash_obj::remove( ::String key){
	HX_STACK_PUSH("Hash::remove","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",41);
	HX_STACK_THIS(this);
...
bool Hash_obj::exists( ::String key){
	HX_STACK_PUSH("Hash::exists","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(37)
...
Dynamic Hash_obj::get( ::String key){
	HX_STACK_PUSH("Hash::get","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",33);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(33)
...
{
		HX_STACK_PUSH("Hash::set","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Hash.hx",29);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("Hash"), hx::TCanCast< Hash_obj> ,sStaticFields,sMemberFields,
