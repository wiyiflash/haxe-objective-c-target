...
{
HX_STACK_PUSH("IntHash::new","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/IntHash.hx",26);
{
	HX_STACK_LINE(26)
...
::String IntHash_obj::toString( ){
	HX_STACK_PUSH("IntHash::toString","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/IntHash.hx",56);
	HX_STACK_THIS(this);
	HX_STACK_LINE(57)
...
Dynamic IntHash_obj::iterator( ){
	HX_STACK_PUSH("IntHash::iterator","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/IntHash.hx",51);
	HX_STACK_THIS(this);
	HX_STACK_LINE(52)
...
Dynamic IntHash_obj::keys( ){
	HX_STACK_PUSH("IntHash::keys","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/IntHash.hx",46);
	HX_STACK_THIS(this);
	HX_STACK_LINE(47)
...
bool IntHash_obj::remove( int key){
	HX_STACK_PUSH("IntHash::remove","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/IntHash.hx",42);
	HX_STACK_THIS(this);
...
bool IntHash_obj::exists( int key){
	HX_STACK_PUSH("IntHash::exists","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/IntHash.hx",38);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(38)
...
Dynamic IntHash_obj::get( int key){
	HX_STACK_PUSH("IntHash::get","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/IntHash.hx",34);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(34)
...
{
		HX_STACK_PUSH("IntHash::set","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/IntHash.hx",30);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("IntHash"), hx::TCanCast< IntHash_obj> ,sStaticFields,sMemberFields,
