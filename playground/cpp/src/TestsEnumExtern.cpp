...
::TestsEnumExtern TestsEnumExtern_obj::ExternEnumValue1;

::TestsEnumExtern TestsEnumExtern_obj::ExternEnumValue2;

::TestsEnumExtern TestsEnumExtern_obj::ExternEnumValue3;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("TestsEnumExtern"), hx::TCanCast< TestsEnumExtern_obj >,sStaticFields,sMemberFields,
