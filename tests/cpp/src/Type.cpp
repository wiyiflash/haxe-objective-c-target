...
::Class Type_obj::getClass( Dynamic o){
	HX_STACK_PUSH("Type::getClass","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",35);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(36)
...
::Enum Type_obj::getEnum( Dynamic o){
	HX_STACK_PUSH("Type::getEnum","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",46);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(47)
	if (((o == null()))){
		HX_STACK_LINE(47)
...
::Class Type_obj::getSuperClass( ::Class c){
	HX_STACK_PUSH("Type::getSuperClass","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",52);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(52)
	return c->GetSuper();
}
...
::String Type_obj::getClassName( ::Class c){
	HX_STACK_PUSH("Type::getClassName","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",56);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(57)
	if (((c == null()))){
		HX_STACK_LINE(58)
...
::String Type_obj::getEnumName( ::Enum e){
	HX_STACK_PUSH("Type::getEnumName","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",62);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(62)
	return e->__ToString();
}
...
::Class Type_obj::resolveClass( ::String name){
	HX_STACK_PUSH("Type::resolveClass","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",66);
...
::Enum Type_obj::resolveEnum( ::String name){
	HX_STACK_PUSH("Type::resolveEnum","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",73);
	HX_STACK_ARG(name,"name");
	HX_STACK_LINE(74)
	::Class result = ::Class_obj::Resolve(name);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(75)
...
Dynamic Type_obj::createInstance( ::Class cl,Dynamic args){
	HX_STACK_PUSH("Type::createInstance","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",80);
	HX_STACK_ARG(cl,"cl");
...
Dynamic Type_obj::createEmptyInstance( ::Class cl){
	HX_STACK_PUSH("Type::createEmptyInstance","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",86);
	HX_STACK_ARG(cl,"cl");
	HX_STACK_LINE(86)
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Dynamic params){
	HX_STACK_PUSH("Type::createEnum","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",90);
	HX_STACK_ARG(e,"e");
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,Dynamic params){
	HX_STACK_PUSH("Type::createEnumIndex","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",96);
	HX_STACK_ARG(e,"e");
...
Array< ::String > Type_obj::getInstanceFields( ::Class c){
	HX_STACK_PUSH("Type::getInstanceFields","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",102);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(102)
...
Array< ::String > Type_obj::getClassFields( ::Class c){
	HX_STACK_PUSH("Type::getClassFields","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",106);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(106)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	HX_STACK_PUSH("Type::getEnumConstructs","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",110);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(110)
...
::ValueType Type_obj::_typeof( Dynamic v){
	HX_STACK_PUSH("Type::typeof","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",114);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(115)
	if (((v == null()))){
		HX_STACK_LINE(115)
...
bool Type_obj::enumEq( Dynamic a,Dynamic b){
	HX_STACK_PUSH("Type::enumEq","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",130);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(130)
	return (a == b);
...
::String Type_obj::enumConstructor( Dynamic e){
	HX_STACK_PUSH("Type::enumConstructor","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",134);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(134)
	return e->__Tag();
}
...
Dynamic Type_obj::enumParameters( Dynamic e){
	HX_STACK_PUSH("Type::enumParameters","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",138);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(139)
...
int Type_obj::enumIndex( Dynamic e){
	HX_STACK_PUSH("Type::enumIndex","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",143);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(143)
	return e->__Index();
}
...
Dynamic Type_obj::allEnums( ::Enum e){
	HX_STACK_PUSH("Type::allEnums","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/Type.hx",147);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(148)
