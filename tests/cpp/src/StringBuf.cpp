...
{
HX_STACK_PUSH("StringBuf::new","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/StringBuf.hx",27);
{
	HX_STACK_LINE(27)
...
::String StringBuf_obj::toString( ){
	HX_STACK_PUSH("StringBuf::toString","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/StringBuf.hx",43);
	HX_STACK_THIS(this);
	HX_STACK_LINE(43)
...
{
		HX_STACK_PUSH("StringBuf::addChar","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/StringBuf.hx",39);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(39)
...
{
		HX_STACK_PUSH("StringBuf::addSub","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/StringBuf.hx",35);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
...
{
		HX_STACK_PUSH("StringBuf::add","/Users/Cristi/Documents/haxecompiler/haxe/std/cpp/_std/StringBuf.hx",31);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(31)
