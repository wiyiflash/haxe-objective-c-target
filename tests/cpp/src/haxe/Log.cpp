...
{
		HX_STACK_PUSH("Log::trace","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/Log.hx",26);
		HX_STACK_ARG(v,"v");
...
Void run(){
{
		HX_STACK_PUSH("Log::clear","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/Log.hx",53);
	}
return null();
}
