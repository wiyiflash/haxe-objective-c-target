...
{
HX_STACK_PUSH("FastListIterator::new","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",42);
{
	HX_STACK_LINE(42)
	this->current = head;
}
...
Dynamic FastListIterator_obj::next( ){
	HX_STACK_PUSH("FastListIterator::next","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",40);
	HX_STACK_THIS(this);
	HX_STACK_LINE(40)
...
bool FastListIterator_obj::hasNext( ){
	HX_STACK_PUSH("FastListIterator::hasNext","/Users/Cristi/Documents/haxecompiler/haxe/std/haxe/FastList.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_LINE(39)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxe._FastList.FastListIterator"), hx::TCanCast< FastListIterator_obj> ,sStaticFields,sMemberFields,
